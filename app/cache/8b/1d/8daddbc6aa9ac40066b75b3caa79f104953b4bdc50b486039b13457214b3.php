...
class __TwigTemplate_8b1d8daddbc6aa9ac40066b75b3caa79f104953b4bdc50b486039b13457214b3 extends Twig_Template
{
    ...
    public function block_head($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "hasexception")) {
            ...
            ";
            // line 6
            echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_profiler_exception_css", array("token" => (isset($context["token"]) ? $context["token"] : null))));
            echo "
        </style>
    ";
        }
...
";
    ...
    ";
            ...
            ";
            // line 33
            echo $this->env->getExtension('silex')->render($this->env, $this->env->getExtension('routing')->getPath("_profiler_exception", array("token" => (isset($context["token"]) ? $context["token"] : null))));
            echo "
        </div>
    ";
        }
